...
namespace TexasHoldemAI
{
    class Program
    {
        ...
        private static int oppshouldc = 0;
        private static int earnchips = 0;
            ...
            switch (iHumanActionCode)
            {
                ...
                case 3:
                    if (a >= (int)thdata.Moneys[0])
                    {
                        ...
                        else if (20000 - (int)thdata.Moneys[0] - earnchips >= oppshouldc)//已经加注足够多，弃牌会导致对手全弃也能赢
                        {
                            r = 2;
                        }
                        else r = 6;
        ...
        private static void SendAction(int r,int cs,int amount,Socket socket_send,ref TexasHoldemData td)
        {
                ...
                else if (temp[0].Equals("preflop"))
                {
                    ...
                    if (WinFlag == 0)
                    {
                        ...
                        if ((70 - NumOfGames) % 2 == 0)
                        {
                            ...
                            oppshouldc = ((70 - NumOfGames) / 2) * 150;
                        }
                        else
                        {
                            if (td.Blindpos == 1)
                            {
                                ...
                                oppshouldc = ((69 - NumOfGames) / 2) * 150 + 100;
                            }
                            else
                            {
                                shouldc = ((69 - NumOfGames) / 2) * 150 + 100;
                                oppshouldc = ((69 - NumOfGames) / 2) * 150 + 50;
                            }
                        }
                    }
                    allinflag = false;
